                ...
                <div class="col-md-12">
                    <form action="{{url('/savedProject')}}" method="POST">
                     ...
                     <label for="title"><b>Nombre Proyecto:</b></label>
                         <input type="hidden" name="post_id" value="{{ isset($project) ? $project->idproject : '' }}">
                         <input type="text" name="name" id="name" class="form-control" placeholder="Título..." value="{{isset($project) ? $project->name : '' }}">
                     <label for="publish_date"><b>Empresa u Organización:</b></label>
                         <input type="text" name="enterprise" id="enterprise" class="form-control" placeholder="" value="{{isset($project) ? $project->enterprise : '' }}">
                     <label for="publish_date"><b>URL Proyecto:</b></label>
                         <input type="text" name="urlproject" id="urlproject" class="form-control" placeholder="" value="{{isset($project) ? $project->url : '' }}">
                     <label for="publish_date"><b>URL Galería:</b></label>
                         <input type="text" name="urlgalery" id="urlgalery" class="form-control" placeholder="" value="{{isset($project) ? $project->urlgaleria : '' }}">
                     <label for="publish_date"><b>Tecnologías:</b></label>
                         <textarea type="text" name="description" id="description" class="form-control" placeholder="Descripción..." rows="3">{{ isset($project) ? $project->technology : '' }}</textarea>
