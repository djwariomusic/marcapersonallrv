...
<p align="justify">Generar todo el proceso de ingeniería de software, desarrollando un sistema de información web que cumpla
todas las expectativas de nuestro cliente prospecto, tanto en temas de apariencia, funcionalidad, seguridad y
rendimiento.</p>
<h3>OBJETIVOS ESPECIFICOS</h3>
<ul>
  <li>Describir de la forma más detallada todos los aspectos relevantes en el ciclo de vida de creación de software.</li>
  <li>Dar importancia a la etapa de análisis y diseño como pieza fundamental del desarrollo e implementación.</li>
  <li>Utilizar el mayor número de tecnologías disponibles para dar una solución sencilla y robusta que cumpla todos los criterios de evaluación.</li>
  <li>Establecer un presupuesto estimado, que permita realizar una propuesta económica acorde a las gastos y ganancias esperadas.</li>
  <li>Diseñar una planeación detallada que sea acorde a la realidad al proyecto planteado.</li>
</ul>
</body>
</html>
